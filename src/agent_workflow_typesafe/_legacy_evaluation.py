"""Legacy comparative-evaluation compatibility implementation.

This module preserves the 0.1.0 behavior when the optional shared
`agent-workflow-comparative-eval` package is not installed. It is not the
canonical owner of comparative-evaluation semantics after 0.1.1.
